...
class AdminController extends Controller {
     ...
     * @return void
     */
    function CRUDGET($table = "Post", $Id = null) {
        $this->CheckLogin(); // Check login
        ...
        $form ='<div class="modal' . ((isset($Id) || isset($_GET['new'] )) ? ' show' : '') . '"
        id="basicExampleModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
        <div class="modal-content">
        <div class="modal-body">';
        
        $form .= "<form action=\"" . _Root . 'Admin/CRUD/'
        . $table . (isset($Id) ? "/" . $Id : '') . "\"
        class=\"gordarg-form\"
        method=\"post\">";
        ...
        if (count($result) > 0) {
            ...
            else if ($mode == 'update')
            {
                ...
                $form .= '<a href="' . _Root . "/Admin/CRUD/" . $table . '" class="btn btn-default pink darken-1 btn-sm m-4">Cancel</a>';
                $form .= "</form>";                
     ...
     * CRUDPOST
     * 
     * When a button on CRUD form is clicked
     * 
     * 
     * @return void
     * 
     */
    function CRUDPOST($table = "Post", $Id = null) {
        $this->CheckLogin(); // Check login
        ...
        $this->RedirectResponse(_Root . "Admin/CRUD/" . $table);
