...
trait CRUD {
    ...
    function CRUDGET($table = "Post", $Id = null) {
        ...
        $form .= "<form action=\"" . _Root . 'My/CRUD/'
        . $table . (isset($Id) ? "/" . $Id : '') . "\"
        class=\"gordarg-form\"
        method=\"post\">";
        ...
        if (count($result) > 0) {
            ...
            else if ($mode == 'update')
            {
                ...
                $form .= '<a href="' . _Root . "/My/CRUD/" . $table . '" class="btn btn-default pink darken-1 btn-sm m-4">Cancel</a>';
                $form .= "</form>";                
    ...
    function CRUDPOST($table = "Post", $Id = null) {
        ...
        $this->RedirectResponse(_Root . "My/CRUD/" . $table);
